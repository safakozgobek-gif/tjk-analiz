...
def analiz_final(at, bugunku_pist, bugunku_hava):
    ...
    # Handikap ve Kilo Dengesi
    skor = (h_puan * 2.5) - (kilo * 0.4)

    # Pist Uzmanlığı Faktörü (%30)
...
if st.button("🚀 VERİLERİ ÇEK VE ANALİZ ET"):
    with st.spinner('TJK sitesine bağlanılıyor...'):
    ...
    if ham_veriler:
        ...
        surprizler = df.iloc[3:][df.iloc[3:]['Jokey Notu'].str.contains("Usta")]
        ...
        st.error("Bülten verisi çekilemedi. Sabah 09:00'dan sonra tekrar deneyin!")
